const errorArray = [
    [   // from dual 제외
        ...
        //예외처리 [0][2]
        [/APPENDCHILDXML/igs, /ASCIISTR/igs, /BFILENAME/igs, /CAST/igs, /CHARTOROWID/igs, /CLUSTER_ID/igs, /CLUSTER_PROBABILITY/igs, /CLUSTER_SET/igs, /COLLECT/igs, /COMPOSE/igs, /CONVERT/igs, /CORR_S/igs, /CORR_K/igs, /CV/igs, /DBTIMEZONE/igs, /DECONPOSE/igs, /DELETEXML/igs, /DEPTH/igs, /DEREF/igs, /DUMP/igs, /EXISTNODE/igs, /EXTRACT/igs, /EXTRACTVALUE/igs, /FEATURE_ID/igs, /FEATURE_SET/igs, /FEATURE_VALUE/igs, /FIRST/igs, /GROUP_ID/igs, /GROUPING/igs, /GROUPING_ID/igs, /HEXTOROW/igs, /INSERTCHILDXML/igs, /INSERTXMLBEFORE/igs, /LAST/igs, /MAKE_REF/igs, /NEW_TIME/igs, /NLS_CHARSET_DECL_LEN/igs, /NLS_CHARSET_ID/igs, /NLS_CHARSET_NAME/igs, /NVL2/igs, /ORA_HASH/igs, /PATH/igs, /POWERMULTISET/igs, /POWERMULTISET_BY_CARDINALITY/igs, /PREDICTION/igs, /PREDICTION_COST/igs, /PREDICTION_DETAILS/igs, /PREDICTION_PROBABILITY/igs, /PREDICTION_SET/igs, /PRESENTNNV/igs, /PRESENTV/igs, /PREVIOUS/igs, /REFTOHEX/igs, /REGEXP_INSTR/igs, /REGEXP_SUBSTR/igs, /ROUND/igs, /ROWIDTOCHAR/igs, /ROWIDTONCHAR/igs, /SKEWNESS_POP/igs, /SKEWNESS_SAMP/igs, /STATS_BINOMIAL_TEST/igs, /STATS_CROSSTAB/igs, /STATS_F_TEST/igs, /STATS_KS_TEST/igs, /STATS_MODE/igs, /STATS_MW_TEST/igs, /STATS_ONE_WAY_ANOVA/igs, /STATS_T_TEST/igs, /STATS_WSR_TEST/igs, /SYS_DBURIGEN/igs, /SYS_OP_ZONE_ID/igs, /SYS_TYPEID/igs, /SYS_XMLGEN/igs, /TIMESTAMP_TO_SCN/igs, /TO_APPROX_COUNT_DISTINCT/igs, /TO_APPROX_PERCENTILE/igs, /TO_BINARY_DOUBLE/igs, /TO_BINARY_FLOAT/igs, /TO_MULTI_BYTE/igs, /TO_NCHAR/igs, /TO_SINGLE_BYTE/igs, /TRANSLATE+'...'+USING/igs, /TREAT/igs, /UPDATEXML/igs, /USERENV/igs, /VALUE/igs, /XMLCDATA/igs, /XMLSEQUENCE/igs, /XMLSERIALIZE/igs, /XMLTABLE/igs, /XMLTRANSFORM/igs, /XMLCOLATTVAL/igs],
        // /SYS_CONTEXT/igs, /TO_CHAR/igs, 
        //치환
        ...
        //EXTENSION
        [/SOUNDEX/igs, /STANDARD_HASH/igs, /SYS_GUID/igs],
        //빈칸
        [/ADD_MONTHS/igs, /BIN_TO_NUM/igs, /BITAND/igs, /CHR/igs, /CURRENT_DATE/igs, /DECODE/igs, /FROM_TZ/igs, /INSTR/igs, /LAST_DAY/igs, /LNNVL/igs, /ITERATION_NUMBER/igs, /MEDIAN/igs, /MONTHS_BETWEEN/igs, /NANVL/igs, /NEXT_DAY/igs, /SYS_CONNECT_BY_PATH/igs, /SYS_EXTRACT_UTC/igs, /TO_DSINTERVAL/igs, /TO_LOB/igs, /TO_NUMBER/igs, /TO_TIMESTAMP/igs, /TO_TIMESTAMP_TZ/igs, /TO_YMINTERVAL/igs, /TZ_OFFSET/igs, /XMLQUERY/igs, /XMLROOT/igs, /REVERSE/igs, /NLS_SORT/igs, /NUMTODSINTERVAL/igs, /NUMTOYMINTERVAL/igs, /RATIO_TO_REPORT/igs, /SESSIONTIMEZONE/,],
        //공유규칙

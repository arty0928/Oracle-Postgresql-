const errorArray = [ // /\b\b/igs, 
    ...
    [   // 도움말 페이지 확인 필요 [1][0]
        [/\bCORR\b/igs, /\bROUND\b/igs, /\bTO_NCHAR\b/igs, /\bTO_CHAR\b/igs, /\bTRUNC\b/igs, /\bTO_MULTI_BYTE\b/igs, /\bTO_BINARY_FLOAT\b/igs, /\bTO_BINARY_DOUBLE\b/igs, /\bREGEXP_SUBSTR\b/igs, /\bNVL2\b/igs, /\bREGEXP_INSTR\b/igs, /\bNEW_TIME\b/igs, /\bFIRST\b/igs, /\bLAST\b/igs, /\bCAST\b/igs, /\bASCIISTR\b/igs, /\bCONVERT\b/igs, /\bDBTIMEZONE\b/igs, /\bXMLQUERY\b/igs, /\bUPDATEXML\b/igs, /\bXMLSERIALIZE\b/igs, /\bTO_LOB\b/igs, /\bLEAST\b/igs, /\bGREATEST\b/igs, /\bLPAD\b/igs, /\bRPAD\b/igs, /\bSYS_GUID\b/igs, /\bUID\b/igs, /\bTZ_OFFSET\b/igs],
        ["CORR", "ROUND", "TO_NCHAR", "TO_CHAR", "TRUNC", "TO_MULTI_BYTE", "TO_BINARY_FLOAT", "TO_BINARY_DOUBLE", "REGEXP_SUBSTR", "NVL2", "REGEXP_INSTR", "NEW_TIME", "FIRST", "LAST", "CAST", "ASCIISTR", "CONVERT", "DBTIMEZONE", "XMLQUERY", "UPDATEXML", "XMLSERIALIZE", "TO_LOB", "LEAST", "GREATEST", "LPAD", "RPAD", "SYS_GUID", "UID", "TZ_OFFSET"]
    ],
    [
        //쿼리핸들러 [2][0]
        [/CONNECT\s*BY/igs]

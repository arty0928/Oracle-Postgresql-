            ...
            <div className="w-full lg:w-1/2 px-4 py-2">
              ...
              <details className="mb-4 bg-gray-200 rounded-md py-2 px-4">
                ...
                <div className="pl-4">
                  ...
                  <p>POSIX-Style의 Timezone 표기법인 STDoffset, STDoffeset DST 형태의 경우 POSIX-Style에서 UTC로부터 서쪽으로 시간상 얼마나 떨어져 잇는지를 계산한다. 따라서 AT TIME ZONE 'UTC+9'의 경우, 대한민국은 그리니치 천문대 기준으로 대칭적 위치의 시간대에 해당하여 값에 오차가 생긴다.</p>

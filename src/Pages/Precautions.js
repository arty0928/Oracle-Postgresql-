                    ...
                    <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
                        <div className="w-full lg:w-1/2 px-4 py-2">
                            ...
                            <details className="mb-4 bg-gray-200 rounded-md py-2 px-4">
                                ...
                                <div className="pl-4">
                                    <p>테이블을 정의하는 DDL 쿼리문에서 INCLUDING ~ OVERFLOW 구문을 삭제해야 합니다. </p>
                                    <p className="p-4 text-pink-700">ex) <br></br>
                                        <span className="font-semibold">ORACLE:</span> CREATE TABLE test ( id NUMBER CONSTRAINT test_pk_id  PRIMARY KEY, name VARCHAR2(30)) <span className="font-semibold">ORGANIZATION INDEX NOCOMPRESS INCLUDING name OVERFLOW TABLESPACE users;</span><br></br>
                                        <span className="font-semibold">PostgreSQL:</span> CREATE TABLE test ( id NUMERIC CONSTRAINT test_pk_id  PRIMARY KEY, name VARCHAR(30));
                                    </p>
                                </div>
                            </details>
                            ...
                            <details className="mb-4 bg-gray-200 rounded-md py-2 px-4">
                                ...
                                <div className="pl-4">
                                    <p>PostgreSQL은 LOB 데이터 타입은 물론 LOB STORE 기능을 지원하지 않으므로 LOB STORE 구문이 포함되어 있다면 이를 모두 삭제해야 합니다. </p>
                                </div>
                            </details>
                        ...
                        <div className="w-full lg:w-1/2 px-4 py-2">
                            ...
                            <details className="mb-4 bg-gray-200 rounded-md py-2 px-4">
                                ...
                                <div className="pl-4">
                                    <p>PostgreSQL은 END LABEL과 START LABEL이 다를 때 오류가 발생합니다. 이 경우 END LABEL을 제거해 주어야 합니다.  </p>
                                    <p className="p-4 text-pink-700"> ex) <br></br> 아래와 같은 경우 오류 발생 CREATE OR REPLACE PACKAGE startlabel is ~<br></br>END endlabel ; </p>
                                </div>
                            </details>
                            ...
                            <details className="mb-4 bg-gray-200 rounded-md py-2 px-4">
                                ...
                                <div className="pl-4">
                                    <p>pgtt extension을 설치하면 PostgreSQL에서도 GLOBAL TEMPORARY TABLE을 원활하게 사용할 수 있습니다. PostgreSQL에서 GLOBAL TEMPORARY TABLE을 사용할 때는 스키마 이름을 제거해야 합니다.</p>
                                </div>
                            </details>
                            ...
                            <details className="mb-4 bg-gray-200 rounded-md py-2 px-4">
                                ...
                                <div className="pl-4">
                                    <p>PostgreSQL에서는 INDEX에 함수 또는 식이 포함된 괄호를 한 번 더 괄호로 감싸주어야 합니다.  </p>
                                    <p className="p-4 text-pink-700"> ex) <br></br> CREATE INDEX indexname ON tablename ((meta->>’example’)); </p>
                                </div>
                            </details>
                            ...
                            <details className="mb-4 bg-gray-200 rounded-md py-2 px-4">
                                ...
                                <div className="pl-4">
                                    <p>ORACLE의 EXTERNAL TABLE 기능을 PostgreSQL의 FOREIGN TABLE로 대체할 수 있습니다.</p>
                                </div>
                            </details>
                            ...
                            <details className="mb-4 bg-gray-200 rounded-md py-2 px-4">
                                ...
                                <div className="pl-4">
                                    <p>ORACLE의 중첩테이블을 PostgreSQL에서도 배열을 이용하여 비슷하게 구현할 수는 있지만, 이를 중첩테이블이라 부르지는 않습니다.</p>
                                    <p>또한 PostgreSQL은 이러한 테이블에서의 NOT NULL 기능을 지원하지 않으므로 중첩테이블 구문에 NOT NULL이 포함되어 있다면 삭제해야 합니다.</p>
                                </div>
                            </details>
                            ...
                            <details className="mb-4 bg-gray-200 rounded-md py-2 px-4">
                                ...
                                <div className="pl-4">
                                    <p>PostgreSQL에서 컬럼을 수정할 때는 ‘ALTER 컬럼명’ 형식의 구문을 사용합니다.</p>
                                </div>
                            </details>
                            ...
                            <details className="mb-4 bg-gray-200 rounded-md py-2 px-4">
                                ...
                                <div className="pl-4">
                                    <p>PostgreSQL에서 GENERATED~IDENTITY 구문을 사용할 때 주의할 사항은 다음과 같습니다.</p>
                                    <p>1) INT 자료형 → BIGINT 자료형 변환</p>
                                    <p>2) ORDER 또는 NOORDER 제거<br></br>GENERATED_IDENTITY_CACHED에서 같이 처리합니다. </p>
                                </div>
                            </details>
